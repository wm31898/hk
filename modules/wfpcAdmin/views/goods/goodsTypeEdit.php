...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" action="/wfpcAdmin/goods/goods-type-edit" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkForm();">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">商品分類名<span class="red">*</span></label>
				<div class="col-sm-9">
					<input placeholder="商品分類名" class="col-xs-10 col-sm-5" type="text" name="type_name" value="<?php echo $data['type_name']; ?>">
				</div>
			</div>
