...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" action="/wfpcAdmin/goods/goods-edit" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkForm();">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">商品標題<span class="red">*</span></label>
				<div class="col-sm-9">
					<input placeholder="商品標題" class="col-xs-10 col-sm-5" type="text" name="name" value="<?php echo $data['name']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea placeholder="商品概述" class="col-xs-10 col-sm-5" name="excerpt"><?php echo $data['excerpt']; ?></textarea>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<script id="editor" name="description" type="text/plain" style="min-width:80%; min-height:300px;"><?php echo $data['description']; ?></script>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input placeholder="購買鏈接" class="col-xs-10 col-sm-5" type="text" name="link_url" value="<?php echo $data['link_url']; ?>">
				</div>
			</div>
