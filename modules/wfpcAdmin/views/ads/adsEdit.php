...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" action="/wfpcAdmin/ads/ads-edit" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkForm();">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">標題<span class="red">*</span></label>
				<div class="col-sm-9">
					<input placeholder="標題" class="col-xs-10 col-sm-5" type="text" name="title" value="<?php echo $data['title']; ?>">
				</div>
			</div>
			...
			<!--<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="col-xs-10 col-sm-5" name="description"><?php echo $data['description']; ?></textarea>
				</div>
			</div>
					...
					<select class="col-sm-5" name="type">
						<?php
	                        ...
	                        foreach($type_list as $k=>$v){
	                            if(isset($data['type']) && $data['type']==$k){
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					...
					<input type="text" class="datetime-picker" name="publish_time" value="<?php echo date('Y-m-d H:i:s',$data['publish_time']); ?>" readonly>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<i class="icon-calendar bigger-110"></i>
					<input type="text" class="datetime-picker" name="end_time" value="<?php echo date('Y-m-d H:i:s',$data['end_time']); ?>" readonly>
				</div>
			</div>-->
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input placeholder="點擊鏈接" class="col-xs-10 col-sm-5" type="text" name="link" value="<?php echo $data['link']; ?>">
				</div>
			</div>
			...
			<!--<div class="form-group">
				...
				<div class="col-sm-9">
					<input placeholder="视频鏈接" class="col-xs-10 col-sm-5" type="text" name="video_url" value="<?php echo $data['video_url']; ?>">
				</div>
			</div>-->
