...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" action="/wfpcAdmin/article/article-cate-add" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkForm();">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">文章分類名<span class="red">*</span></label>
				<div class="col-sm-9">
					<input placeholder="文章分類名" class="col-xs-10 col-sm-5" type="text" name="title" value="">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="col-xs-10 col-sm-5" placeholder="分類简介" name="brief"></textarea>
				</div>
			</div>
