...
<div class="widget-box">
    ...
    <div class="widget-body">
        <div class="widget-main">
            <form class="form-inline" action="/wfpcAdmin/article/article-cate-list">
                ...
                <span>分類名：</span><input class="margin-r-10" placeholder="分類名" type="text" name="title" value="<?php echo isset($get_data['title']) && $get_data['title']!='' ? $get_data['title']:''; ?>">
                ...
                <a class="btn btn-purple btn-sm" href="/wfpcAdmin/article/article-cate-list">清除<i class="icon-undo icon-on-right bigger-110"></i></a>
                <a class="btn btn-primary btn-sm" href="/wfpcAdmin/article/article-cate-add">添加文章分類<i class="icon-pencil icon-on-right bigger-110"></i></a>
            </form>
        </div>
    </div>
</div>

<h3 class="header smaller lighter blue">文章分類列表</h3>
        ...
        ?>
                <tr>
                    ...
                    <td>
						<?php
							if($v['icon_url']!=''){
								echo '<img src="'.$v['icon_url'].'" width="100" height="100">';
							}else{
								echo '暫無圖标';
							}
						?>
                    ...
                    <td>
                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                            <a class="btn btn-xs btn-info" href="/wfpcAdmin/article/article-cate-details?id=<?php echo $v['id']; ?>"><i class="icon-edit bigger-120"></i></a>
                            <a class="btn btn-xs btn-danger" href="javascript:;" onClick="html_confirm('是否要删除該文章分類？',delData,<?php echo $v['id']; ?>,$(this));"><i class="icon-trash bigger-120"></i></a>
                        </div>
                    </td>
                </tr>
        <?php
...
<script type="text/javascript">
	...
	function delData(id,i){
		if(id>0){
			$.ajax({
			   url: '/wfpcAdmin/article/article-cate-delete',
			   data: {'id':id},
			   type: "Post",
			   //dataType: "json",
