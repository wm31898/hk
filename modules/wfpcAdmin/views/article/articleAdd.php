...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" action="/wfpcAdmin/article/article-add" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkForm();">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">文章標題<span class="red">*</span></label>
				<div class="col-sm-9">
					<input placeholder="文章標題" class="col-xs-10 col-sm-5" type="text" name="title" value="">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea placeholder="文章概述" class="col-xs-10 col-sm-5" name="excerpt"></textarea>
				</div>
			</div>
			...
			<div class="form-group cate_type_1">
				...
				<div class="col-sm-9">
					<input placeholder="小標題" class="col-xs-10 col-sm-5" type="text" name="tag_title" value="">
				</div>
			</div>
