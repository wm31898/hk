...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" action="/wfpcAdmin/article/article-cate-edit" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkForm();">
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">文章分類名<span class="red">*</span></label>
				<div class="col-sm-9">
					<input placeholder="文章分類名" class="col-xs-10 col-sm-5" type="text" name="title" value="<?php echo $data['title']; ?>">
				</div>
			</div>
							...
							<div class="z_photo upimg-div clear" >
								...
								?>
									<section class="up-section fl">
										...
										<img class="up-img" src="<?php echo $data['icon_url']; ?>">
										<input name="icon" value="<?php echo $data['icon']; ?>" type="hidden">
									</section>
								<?php	
									}
								?>
			...
			<div class="form-group">
				<label class="col-sm-3 control-label no-padding-right" for="form-field-1">分類简介</label>
				<div class="col-sm-9">
					<textarea class="col-xs-10 col-sm-5" placeholder="分類简介" name="brief"><?php echo $data['brief']; ?></textarea>
				</div>
			</div>
