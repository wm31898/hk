...
<div class="widget-box">
    ...
    <div class="widget-body">
        <div class="widget-main">
            <form class="form-inline" action="/wfpcAdmin/news/news-cate-list">
                ...
                <a class="btn btn-purple btn-sm" href="/wfpcAdmin/news/news-cate-list">清除<i class="icon-undo icon-on-right bigger-110"></i></a>
                <a class="btn btn-primary btn-sm" href="/wfpcAdmin/news/news-cate-add">添加新聞分類<i class="icon-pencil icon-on-right bigger-110"></i></a>
            </form>
        </div>
    </div>
</div>

<h3 class="header smaller lighter blue">新聞分類列表</h3>
...
/*							if($v['icon_url']!=''){
                    ...
                    <td>
						<a class="btn btn-xs btn-info" href="/wfpcAdmin/news/news-cate-details?id=<?php echo $v['id']; ?>"><i class="icon-edit bigger-120"></i></a>
						<a class="btn btn-xs btn-danger" href="javascript:;" onClick="html_confirm('是否要刪除該新聞分類？',delData,<?php echo $v['id']; ?>,$(this));"><i class="icon-trash bigger-120"></i></a>
                    </td>
                </tr>
        <?php
                }
...
<script type="text/javascript">
	...
	function delData(id,i){
		if(id>0){
			$.ajax({
			   url: '/wfpcAdmin/news/news-cate-delete',
			   data: {'id':id},
			   type: "Post",
			   //dataType: "json",
